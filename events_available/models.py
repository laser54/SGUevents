...
class Events_online(models.Model):
    ...
    events_admin = models.ForeignKey(User, on_delete=models.SET_DEFAULT, default="1", related_name='admin_online', verbose_name="Администратор")
...
class Events_offline(models.Model):
    ...
    events_admin = models.ForeignKey(User, on_delete=models.SET_DEFAULT, default="1", related_name='admin_offline', verbose_name="Администратор")
    documents = models.FileField(blank=True, null=True, verbose_name='Документы')
